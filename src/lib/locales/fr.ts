...
export const fr = {
  ...
  prompts: {
    ...
    "loup-noir":
      "Infectez la victime (1 seule fois par partie) et/ou imposez le silence à un joueur.",
    "loup-blanc": "Voulez-vous dévorer un loup-garou cette nuit ?",
    "loup-bavard":
      "Le MJ vous montre le mot secret : vous devez impérativement le placer lors du débat du matin.",
