...
const NARRATION: Partial<Record<Lang, Table>> & { fr: Table } = {
  fr: {
    ...
    renardVagueProtect: "Une lueur bienveillante veille près d'une maison.",
    renardVaguePoison: "Une odeur d'herbes amères flotte dans l'air.",
  ...
  en: {
    ...
    renardVagueProtect: "A benevolent glimmer watches over a house.",
    renardVaguePoison: "A scent of bitter herbs lingers in the air.",
  ...
  ar: {
    ...
    renardVagueProtect: "وميض خيّر يحرس أحد البيوت.",
    renardVaguePoison: "رائحة أعشاب مرة تعبق في الهواء.",
  ...
  es: {
    ...
    renardVagueProtect: "Un brillo benevolente vela sobre una casa.",
    renardVaguePoison: "Un aroma a hierbas amargas flota en el aire.",
  ...
  pt: {
    ...
    renardVagueProtect: "Um brilho benevolente vigia uma casa.",
    renardVaguePoison: "Um cheiro de ervas amargas paira no ar.",
  ...
  ru: {
    ...
    renardVagueProtect: "Добрый блеск сторожит один из домов.",
    renardVaguePoison: "Запах горьких трав витает в воздухе.",
  ...
  zh: {
    ...
    renardVagueProtect: "一道善意的光芒守护着一栋房屋。",
    renardVaguePoison: "苦涩草药的气味弥漫在空气中。",
  ...
  de: {
    ...
    renardVagueProtect: "Ein gütiger Schimmer wacht über ein Haus.",
    renardVaguePoison: "Ein Geruch nach bitteren Kräutern liegt in der Luft.",
